...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _h('div', {
	    ...
	    return [_h('span', {
	      class: [(_vm.monthNames[_vm.parse(_vm.value).getMonth()] === m) &&
	        _vm.currDate.getFullYear() === _vm.parse(_vm.value).getFullYear() && _vm.prefixCls + '-calendar-dateRange-item-active'
	      ],
	      on: {
	        "click": function($event) {
	    ...
	    return [_h('span', {
	      class: [_vm.parse(_vm.value).getFullYear() === decade.text && _vm.prefixCls + '-calendar-dateRange-item-active'],
	      on: {
	        "click": function($event) {
