...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [(_vm.renderData.length > _vm.showLen && _vm.showLen >= 3) ? _c('span', {
	    class: [_vm.prefixCls + '-tab-arrow-prev'],
	    on: {
	      "click": _vm.prev
	    }
	  }, [(_vm.prev_tabIndex == 0) ? _c('icon', {
	    staticStyle: {
	      "cursor": "not-allowed"
	    },
	    attrs: {
	  ...
	  })], 1) : _vm._e(), _vm._v(" "), (_vm.trigger == 'click') ? _c('ul', {
	    ...
	    return _c('li', {
	      ...
	      domProps: {
	        "innerHTML": _vm._s(r.customHeader)
	      }
	    }) : _c('a', {
	      attrs: {
	  ...
	  })), _vm._v(" "), (_vm.renderData.length > _vm.showLen && _vm.showLen >= 3) ? _c('span', {
	    class: [_vm.prefixCls + '-tab-arrow-next'],
	    on: {
	      "click": _vm.next
	    }
	  }, [(_vm.next_tabIndex == _vm.maxTabIndex) ? _c('icon', {
	    staticStyle: {
	      "cursor": "not-allowed"
	    },
	    attrs: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  mounted: function mounted() {
	    var customHeader = this.$slots && this.$slots.header && this.$slots.header[0].elm.outerHTML || '';
