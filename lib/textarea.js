...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_c('span', [_vm._v(_vm._s(_vm.content))]), _c('br')])] : _vm._e(), _vm._v(" "), _c('textarea', _vm._b({
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (_vm.content),
	  ...
	  }))], 2), _vm._v(" "), (_vm.limitWords) ? _c('p', {
	    class: _vm.wordClassObj
	  }, [_vm._v(_vm._s(_vm.curWords) + "/" + _vm._s(_vm.limitWords))]) : _vm._e(), _vm._v(" "), (_vm.wordsCount) ? _c('p', {
	    class: [_vm.prefixCls + '-textarea-words-area']
	  }, [_vm._v(_vm._s(_vm.countTips) + _vm._s(_vm.curWords))]) : _vm._e()])
	},staticRenderFns: []}
