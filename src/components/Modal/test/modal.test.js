...
describe('Modal', () => {
  let vm = new Vue({
    ...
    template: `
      <div>
        <modal title="Zoom Modal" :show="show" effect="zoom" width="400px" :callback="modalCallback">
        ...
        <modal title="modal2" :show="show" width="400px" backdrop :callback="modalCallback">
          <div slot="modal-header"></div>
  ...
  it('Modal组件是否正常显示', () => {
    expect(vm.$el.querySelectorAll('.atui-modal').length).to.equal(2)
  })
